...
export default function SetupScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      >
        <h1 className="font-display text-4xl font-bold text-center mb-8 text-white">
          Game Setup
        </h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <h3 className="font-semibold text-xl mb-4 text-white">Difficulty Level</h3>
          ...
          <Card>
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-lg text-white">AI Word Generator</h3>
              <button
